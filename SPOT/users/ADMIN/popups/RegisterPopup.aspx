...
<head runat="server">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            // Store initial table rows as DOM nodes
        ...
        function groupLogs() {
            ...
            const groups = {};
            const now = new Date("2025-05-15T00:00:00");
        ...
        function showUserInfo(loggedBy) {
            ...
            container.innerHTML = `
                ...
                <p><strong>Name:</strong> ${loggedBy}</p>
                <p><strong>Email:</strong> ${loggedBy.toLowerCase()}@example.com</p>
                <p><strong>Role:</strong> Administrator</p>
                <p><strong>Last Active:</strong> 2025-05-15</p>
            `;
        ...
        function closeUserInfo() {
            ...
            const tbody = document.querySelector(".logs-content table tbody");
            if (!tbody.querySelector("tr") || tbody.innerHTML.includes("No logs found")) {
                while (tbody.firstChild) tbody.removeChild(tbody.firstChild);
        ...
        function downloadNow() {
            ...
            // Clear the table only after download
                    ...
                    <tbody>
                        ...
                        %>
                            <tr>
                                ...
                                <td>
                                    <span class="logged-by-link" onclick="showUserInfo('<%= row["LoggedBy"] %>')">
                                        <%= row["LoggedBy"] %>
                                    </span>
                                </td>
                            </tr>
